...
const fadeInVariants = (direction = "up", delay = 0) => ({
  initial: {
    opacity: 0,
    transform:
      direction === "up"
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed bottom-6 right-6 z-50 max-w-xs w-full shadow-lg rounded-lg flex items-center gap-3 px-4 py-3 border
          ${notification.type === "success" ? successClassName : errorClassName}
        `}
      >
